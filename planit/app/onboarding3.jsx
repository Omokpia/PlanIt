        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{justifyContent:'center', alignItems:'center',}}>
                <Text style={{color:'#1B2CC1', fontFamily:"semibold", 
                    fontSize:32,textAlign:"center"}}>Organize. Execute. {'\n'}
                    <Text>Succeed.</Text>
                    </Text>
            </View>
            ...
            <View style={{marginTop:30}}>
                <Text  style={{fontFamily:"regular", color:"#88898B",
                    fontSize:15,textAlign:"center"}}>Plan, assign and track every task
                     from start to finish. Ensure timely delivery and flawless event{'\n'}
                     <Text>execution on PlanIt</Text>
                     </Text>
            </View>

            <View style={{marginTop:50, alignItems:"center",marginBottom:50}}>
                <Image style={{height:16, width:70, resizeMode:'contain'}}
                     source={require('../assets/images/pager3.png')} />
            </View>

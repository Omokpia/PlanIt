// import { Text, View, StyleSheet, TextInput, Image, Keyboard,
...
//                 <Text style={authStyles.mainText}>Welcome to
...
//                         gap:10, borderRightWidth:2, borderColor:COLORS.border, 
...
//                     keyboardType="number-pad" style={{ width:'75%',
//                      paddingLeft:20}} onBlur={()=> Keyboard.dismiss()}/>
//                 </View>
...
//                 <Button onPress={()=> router.push('./verification')}
//                  text={"Continue"}/>
//             </View>

//             <View style={{marginTop:10}}>
//                 <Text style={{textAlign:'center', fontFamily:'regular',
//                      color:COLORS.grey}}>By continuing you agree to our 
//                      <Text style={loginStyles.policy}>Terms of Service
//                         </Text> and <Text style={loginStyles.policy}>
